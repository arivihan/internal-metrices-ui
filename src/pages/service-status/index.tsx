...
const SERVICES = [
	{
		name: "Payments API",
		endpoint: "https://example.com/health/payments",
	},
	{
		name: "Checkout",
		endpoint: "https://example.com/health/checkout",
	},
	{
		name: "Dashboard",
		endpoint: "https://example.com/health/dashboard",
	},
];
		...
		return (
			<div className="flex gap-[4px] mt-2 mb-1">
				{bars.map((color, i) => (
					<div
						key={i}
						className={`h-8 w-1.5 rounded-xs ${
							color === "green"
								? "bg-green-500"
								: color === "orange"
								? "bg-orange-400"
		...
		<div className="min-h-screen w-full bg-background flex flex-col items-center">
			<div className="w-full max-w-2xl mx-auto mt-12 mb-8">
				<div className="flex flex-col items-center text-center">
					...
					<h1 className="text-3xl font-bold mb-2 text-foreground">Status Page</h1>
					<p className="max-w-xl mb-2 text-muted-foreground">
			...
			<div className="w-full max-w-4xl mx-auto flex flex-col gap-6">
				...
				<div className="flex justify-end mt-4">
					<button
						className="px-4 py-2 rounded bg-primary text-primary-foreground font-semibold hover:bg-primary/90 border border-border shadow disabled:opacity-50"
